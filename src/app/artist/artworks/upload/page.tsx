...
export default function UploadArtworkPage() {
  ...
  // Keep the form's images field in sync so Zod validation sees the uploaded images
  useEffect(() => {
    setValue("images", images as ArtworkInput["images"], { shouldValidate: images.length > 0 });
  }, [images, setValue]);
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <form className="space-y-5">
        <div className="space-y-1">
          ...
          {errors.images && (
            <p className="text-xs text-destructive">Please upload at least one image</p>
          )}
        </div>
